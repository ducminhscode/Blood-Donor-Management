...
const DonorList = () => {
    ...
    const fetchDonors = async (isLoadMore = false) => {
        ...
        try {
            ...
            const includesCurrentUser = response.data.results.some(
                donor => donor.account.id === currentUser?.id
            );
            const donorCount = searchTerm.trim()
                ? formattedDonors.length
                : Math.max(response.data.count - (includesCurrentUser ? 1 : 0), 0);

            setHasNextPage(response.data.next !== null);
            setResultsCount(donorCount);
    ...
    const displayedResultsCount = searchTerm.trim() ? resultsCount : totalDonors;
                ...
                return (
                    <div className="flex gap-2 w-full">
                        ...
                        <button
                            ...
                            className="cursor-pointer px-4 py-2.5 bg-red-50 text-red-600 rounded-xl hover:bg-red-100 transition-all duration-300 flex items-center justify-center gap-2"
                            title="Hủy lời mời"
                        >
                ...
                return (
                    <div className="flex gap-2 w-full">
                        <button
                            ...
                            className="cursor-pointer flex-1 px-4 py-2.5 bg-gradient-to-r from-red-600 to-red-500 text-white rounded-xl hover:from-red-700 hover:to-red-600 transition-all duration-300 flex items-center justify-center gap-2 shadow-md"
                        >
                        ...
                        <button
                            ...
                            className="cursor-pointer px-4 py-2.5 border-2 border-red-600 text-red-600 rounded-xl hover:bg-red-50 transition-all duration-300 flex items-center justify-center gap-2"
                            title="Từ chối"
                        >
            ...
            default:
                return (
                    <button
                        ...
                        className="cursor-pointer w-full px-4 py-2.5 bg-gradient-to-r from-red-600 to-red-500 text-white rounded-xl hover:from-red-700 hover:to-red-600 transition-all duration-300 flex items-center justify-center gap-2 shadow-md hover:shadow-lg"
                    >
                                            ...
                                            <div className="p-6">
                                                <div className="flex flex-col items-center text-center">
                                                    ...
                                                    <div className="flex flex-wrap items-center justify-center gap-2 mb-4">
                                                        ...
                                                        <span className={`inline-flex items-center gap-1 px-2.5 py-1 rounded-lg text-xs font-medium text-blue-500 bg-blue-50`}>
                                                            <Target className="w-3 h-3" />
                                                            {donor.donation_count || 0} lần hiến máu
                                                        </span>
                                                        {status === 'friend' && (
