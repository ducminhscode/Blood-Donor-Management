...
import {
    ...
    Filter, Loader2, Send, TrendingUp, CalendarDays
} from 'lucide-react';
                        ...
                        <div className="flex flex-wrap gap-3">
                            ...
                            >
                                ...
                                {pendingRequestsCount > 0 && (
                                    <span className="absolute -top-2 -right-2 bg-yellow-400 text-red-600 text-xs font-bold w-6 h-6 rounded-full flex items-center justify-center animate-bounce shadow-lg">
                                            ...
                                            <div className="flex flex-col items-center text-center">
                                                ...
                                                <div className="w-full space-y-2 text-left mb-4">
                                                    <div className="flex items-center gap-2 text-sm text-gray-600">
                                                        ...
                                                        <span className="truncate">{friend.email || 'Chưa cập nhật'}</span>
                                                    </div>
                                                    <div className="flex items-center gap-2 text-sm text-gray-600">
                                                    ...
                                                    <div className="flex items-center gap-2 text-sm text-gray-600">
                                                        ...
                                                        <span className="truncate">{friend.province || 'Chưa cập nhật'}</span>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    ...
                                                    <div className="flex flex-wrap items-center gap-3 text-xs text-gray-500">
                                                        ...
                                                        <span className="flex items-center gap-1">
                                                            ...
                                                            {friend.email || 'Chưa cập nhật'}
                                                        </span>
                                                        <span className="flex items-center gap-1">
                                                            <Phone className="w-3 h-3 text-gray-400" />
                                                            {friend.phone || 'Chưa cập nhật'}
                                                        </span>
                                                        {friend.province && (
                                                            <span className="flex items-center gap-1">
