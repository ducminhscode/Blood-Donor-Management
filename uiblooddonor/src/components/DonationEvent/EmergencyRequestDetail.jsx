...
import {
    ...
    X, FileText, Ambulance, AlertTriangle, Hospital, Syringe,
    HeartPulse
} from 'lucide-react';
    ...
    return (
        <div className="space-y-3">
            ...
            <div className="flex items-start gap-2 text-sm text-gray-600 bg-gray-50 p-3 rounded-lg">
                ...
                <div>
                    <p className="font-medium text-gray-900">Địa chỉ bệnh viện:</p>
                    <p>{hospital?.hospital_address}, {hospital?.sub_district}, {hospital?.province}</p>
                </div>
            </div>
        </div>
                    ...
                    <div className="p-6">
                        ...
                        <div className="space-y-3 mb-6">
                            <div className="flex justify-between items-center py-2 border-b">
                                ...
                                <span className="font-medium text-gray-900">{emergencyRequest?.patient_name}</span>
                            </div>
                            <div className="flex justify-between items-center py-2 border-b">
                            ...
                            <div className="flex justify-between items-center py-2 border-b">
                                ...
                                <span className="font-medium text-gray-900">{emergencyRequest?.blood_volume}ml</span>
                            </div>
                        </div>
...
const EmergencyRequestDetail = () => {
    ...
    // State cho các yêu cầu cùng khu vực
    ...
    // Fetch các yêu cầu cùng bệnh viện
    useEffect(() => {
            ...
            <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                    <div className="bg-white rounded-3xl shadow-xl p-12 text-center">
                        ...
                        <button
                            onClick={() => navigate('/emergency-request-list')}
                ...
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                    ...
                    <div className="flex items-center justify-between">
                        <button
                            ...
                            className="flex p-1 relative z-20 items-center hover:bg-white/20 hover:text-white rounded-xl transition-all backdrop-blur-sm group"
                        >
                            <div className="rotate-180 p-2 group-hover:-translate-x-1 transition-transform">
                                <ChevronRight className="w-5 h-5" />
                            </div>
                            <span className='mr-1'>Danh sách yêu cầu</span>
                        </button>
                    </div>
                </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white rounded-2xl shadow-sm p-6">
                            <div className="flex items-start justify-between mb-4">
                                <div>
                                    <div className="flex items-center gap-3 mb-3">
                                        <span className={`${status.color} text-white px-3 py-1 rounded-full text-sm font-medium flex items-center gap-1 ${request.critical && !request.is_expire ? 'animate-pulse' : ''}`}>
                                ...
                                {/* Response Button - Desktop */}
                                <div className="hidden lg:block">
                                    {!user ? (
                                        <button
                                            onClick={() => navigate('/login')}
                                            className="flex items-center gap-2 px-6 py-3 rounded-xl font-semibold transition-all transform hover:scale-105 shadow-lg bg-gray-600 text-white hover:bg-gray-700"
                                        >
                                        ...
                                        !hasResponded ? (
                                            ...
                                            <div className="flex items-center gap-2 px-6 py-3 rounded-xl bg-green-50 text-green-700">
                                                <CheckCircle className="w-5 h-5" />
                            ...
                            <div className="lg:hidden mt-4">
                                {!user ? (
                                    <button
                                        onClick={() => navigate('/login')}
                                        className="w-full flex items-center justify-center gap-2 px-6 py-3 rounded-xl font-semibold transition-all shadow-lg bg-gray-600 text-white hover:bg-gray-700"
                                    >
                                        <span>Đăng nhập để hỗ trợ</span>
                                    </button>
                                ) : user.role === 1 && (
                                    !hasResponded ? (
                                        ...
                                        <div className="flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-green-50 text-green-700">
                                            <CheckCircle className="w-5 h-5" />
                                            <span>Đã đăng ký hỗ trợ</span>
                                        </div>
                                    )
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="grid grid-cols-2 gap-4">
                                            ...
                                            <InfoRow
                                                icon={Phone}
                                                label="Hotline"
                                                value={`${request.staff?.emergency_phone || ""}`}
                                            />
                                        </div>
                                    </div>
                                )}
                        ...
                        {loadingRelated ? (
                            ...
                            <div className="grid md:grid-cols-3 gap-6">
                                {relatedRequests.map((relatedRequest) => (
                                    ...
                                    >
                                        <div className="h-32 bg-gradient-to-br from-red-500 to-red-700 rounded-t-xl relative overflow-hidden flex items-center justify-center">
                                            <AlertTriangle className="w-12 h-12 text-white opacity-50" />
                                            <div className="absolute top-2 right-2">
                                                <span className={`${relatedRequest.critical && !relatedRequest.is_expire ? 'bg-red-600' : 'bg-orange-500'} text-white text-xs px-2 py-1 rounded-full`}>
