...
const EmergencyMedicalCheckUpDetail = () => {
    ...
    const emergency = emergencyRequest || checkup.emergency_response?.emergency_request || checkup.emergency_request;
            ...
            <div className="relative overflow-hidden bg-gradient-to-r from-red-700 via-red-600 to-red-500 text-white">
                ...
                <div className="absolute inset-0 overflow-hidden">
                    {[...Array(12)].map((_, i) => (
                        ...
                        >
                            <Stethoscope className="w-6 h-6 text-white opacity-20" />
                        </div>
                    ))}
                </div>
                        ...
                        <div className="bg-white rounded-2xl shadow-md p-6 border border-gray-100">
                            ...
                            <div className="flex flex-wrap gap-3 mt-2">
                                {checkup.is_eligible && bloodDonation && (
                                    <button
                                        onClick={() => navigate(`/emergency-request/${id}/responses/${response_id}/medical-checkup/${checkup.id}/blood-donation`)}
