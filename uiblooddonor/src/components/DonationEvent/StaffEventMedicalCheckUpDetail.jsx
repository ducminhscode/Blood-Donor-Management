...
import {
    ...
    ClipboardCheck, TrendingUp, Award as AwardIcon,
    Stethoscope as StethoscopeIcon, Hospital,
    HandHeart,
    ChevronDown
} from 'lucide-react';
...
const EditMedicalCheckupDialog = ({ isOpen, onClose, onSubmit, checkup, loading }) => {
    ...
    useEffect(() => {
        const handleClickOutside = (event) => {
            if (showResultDropdown && !event.target.closest('.result-dropdown')) {
                setShowResultDropdown(false);
            }
        };
    ...
    const getResultLabel = (value) => {
        if (value === true || value === 'true') return 'Đủ điều kiện hiến máu';
        if (value === false || value === 'false') return 'Không đủ điều kiện hiến máu';
        return 'Chọn kết quả khám';
    };
                ...
                <div className="relative bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto transform transition-all" onClick={e => e.stopPropagation()}>
                    ...
                    <form onSubmit={handleSubmit} className="p-6 space-y-6">
                        ...
                        <div className="bg-gradient-to-r from-gray-50 to-white rounded-xl p-4 border border-gray-100">
                            ...
                            <div className="result-dropdown relative">
                                ...
                                >
                                    <span className={formData.is_eligible !== '' ? "text-gray-900" : "text-gray-400"}>
                                        {getResultLabel(formData.is_eligible)}
                                    </span>
                                    <ChevronDown className={`h-4 w-4 text-gray-500 transition-transform ${showResultDropdown ? 'rotate-180' : ''}`} />
                                </button>
                                ...
                                {showResultDropdown && (
                                    <div className="absolute top-full left-0 mt-2 w-full bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden z-30 animate-fadeIn">
                                        <button
                                            ...
                                            className={`w-full px-4 py-3 text-left hover:bg-gray-50 transition-colors ${formData.is_eligible === true ? 'bg-red-50 text-red-600' : 'text-gray-700'}`}
                                        >
                                        ...
                                        <button
                                            ...
                                            className={`w-full px-4 py-3 text-left hover:bg-gray-50 transition-colors ${formData.is_eligible === false ? 'bg-red-50 text-red-600' : 'text-gray-700'}`}
                                        >
                        ...
                        <div className="flex gap-3 pt-4">
                            <button
                                type="submit"
                                disabled={loading}
                                className="cursor-pointer flex-1 py-3 bg-gradient-to-r from-red-600 to-red-500 text-white rounded-xl font-semibold hover:from-red-700 hover:to-red-600 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 shadow-lg"
                            >
                                {loading ? (
                                    <>
                                    ...
                                    {showBloodTypeDropdown && (
                                        <div className="absolute top-full left-0 mt-2 w-full bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden z-30 animate-fadeIn">
                                            <button
                                                ...
                                                className={`w-full px-4 py-3 text-left hover:bg-gray-50 transition-colors ${formData.blood_type === '0' ? 'bg-red-50 text-red-600' : 'text-gray-700'}`}
                                            >
                                                O
                                            </button>
                                            <button
                                                ...
                                                className={`w-full px-4 py-3 text-left hover:bg-gray-50 transition-colors ${formData.blood_type === '1' ? 'bg-red-50 text-red-600' : 'text-gray-700'}`}
                                            >
                                                A
                                            </button>
                                            <button
                                                ...
                                                className={`w-full px-4 py-3 text-left hover:bg-gray-50 transition-colors ${formData.blood_type === '2' ? 'bg-red-50 text-red-600' : 'text-gray-700'}`}
                                            >
                                                B
                                            </button>
                                            <button
                                                ...
                                                className={`w-full px-4 py-3 text-left hover:bg-gray-50 transition-colors ${formData.blood_type === '3' ? 'bg-red-50 text-red-600' : 'text-gray-700'}`}
                                            >
                                                AB
                                            </button>
                                        </div>
                                ...
                                {showDonationTypeDropdown && (
                                    <div className="absolute top-full left-0 mt-2 w-full bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden z-30 animate-fadeIn">
                                        <button
                                            ...
                                            className={`w-full px-4 py-3 text-left hover:bg-gray-50 transition-colors ${formData.donation_type === '0' ? 'bg-red-50 text-red-600' : 'text-gray-700'}`}
                                        >
                                            Máu toàn phần
                                        </button>
                                        <button
                                            ...
                                            className={`w-full px-4 py-3 text-left hover:bg-gray-50 transition-colors ${formData.donation_type === '1' ? 'bg-red-50 text-red-600' : 'text-gray-700'}`}
                                        >
                                            Tiểu cầu
                                        </button>
                                        <button
                                            ...
                                            className={`w-full px-4 py-3 text-left hover:bg-gray-50 transition-colors ${formData.donation_type === '2' ? 'bg-red-50 text-red-600' : 'text-gray-700'}`}
                                        >
                                            Huyết tương
                                        </button>
                                        <button
                                            ...
                                            className={`w-full px-4 py-3 text-left hover:bg-gray-50 transition-colors ${formData.donation_type === '3' ? 'bg-red-50 text-red-600' : 'text-gray-700'}`}
                                        >
                                            Bạch cầu
                                        </button>
                                    </div>
                    ...
                    <div className="p-6">
                        ...
                        <div className="flex gap-3">
                            <button
                                onClick={onConfirm}
                                disabled={loading}
                                className="cursor-pointer flex-1 py-3 bg-gradient-to-r from-red-600 to-red-500 text-white rounded-xl font-semibold hover:from-red-700 hover:to-red-600 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                            >
                                {loading ? (
                                    <>
                                        <Loader2 className="animate-spin w-5 h-5" />
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
                                ...
                                {canEditOrDelete() && !isCompleted && (
                                    <div className="flex flex-wrap gap-3 justify-end">
                                        <button
                                            ...
                                            className="cursor-pointer inline-flex items-center gap-2 px-4 py-2 bg-gray-100 text-gray-700 rounded-xl hover:bg-gray-200 transition-all duration-300 font-medium"
                                        >
                            ...
                            {isCompleted && (
                                <div className="mt-2 p-3 bg-blue-50 rounded-lg border border-blue-100">
                                    <p className="text-sm text-blue-700 flex items-center gap-2">
                                        ...
                                        Phiếu đăng ký đã hoàn thành, không thể chỉnh sửa hoặc xóa phiếu khám sức khỏe.
                                    </p>
                                </div>
                            )}
            ...
            <style jsx>{`
                ...
                [data-theme="dark"] .medical-vital-card {
                ...
                [data-theme="dark"] .medical-vital-card__icon {
                    background: rgba(15, 23, 42, 0.92) !important;
                    border: 1px solid rgba(100, 116, 139, 0.35);
                    box-shadow: none !important;
                }

                [data-theme="dark"] .medical-vital-card__label {
                    color: #cbd5e1 !important;
                }

                [data-theme="dark"] .medical-vital-card__value {
                    color: #f8fafc !important;
                }

                [data-theme="dark"] .medical-vital-card__unit {
                    color: #94a3b8 !important;
                }

                [data-theme="dark"] .medical-vital-card__icon-svg {
