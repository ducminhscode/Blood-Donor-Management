...
from blooddonorapp.models import Account, RewardCategory, Reward, RecipientInformation, Staff, Hospital
...
class AccountAdmin(admin.ModelAdmin):
    list_display = ("username", "last_name", "first_name", "email", "phone", "gender", "role", "is_staff", "is_active", "last_login", "date_joined")
...
class RewardAdmin(admin.ModelAdmin):
    list_display = ("name", "image_url", "points_required", "remaining_stock", "is_active", "created_at", "updated_at", "reward_category")
...
class RecipientInformationAdmin(admin.ModelAdmin):
    list_display = ("last_name", "first_name", "email", "phone", "province", "sub_district", "recipient_address", "recipient_note", "is_active", "created_at", "updated_at")
